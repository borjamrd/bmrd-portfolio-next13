...
const ProjectCard: FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div className="group bg-cyan-900/90 dark:bg-slate-950/75 hover:bg-transparent hover:dark:bg-transparent backdrop-blur-xxs border-2/1 lg:p-4 p-2 border-neutral-200 dark:border-neutral-700 relative flex items-end aspect-square rounded-3xl overflow-hidden dark:text-white text-gray-50 shadow-sm shadow-slate-700 ">
      ...
      <div className="flex flex-col h-full lg:gap-4 gap-2 w-full duration-200 opacity-0 ease-in-out group-hover:opacity-100">
        ...
        <div className="h-2/5">
          <h4 className="text-neutral-900 dark:text-neutral-100 tracking-tight customtitle xl:text-3xl md:text-xl text-lg lg:leading-tight leading-none  font-bold mb-1">
            {project.name}
          </h4>
